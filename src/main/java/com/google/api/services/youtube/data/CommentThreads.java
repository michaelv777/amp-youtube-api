...
package com.google.api.services.youtube.data;
...
public class CommentThreads {
    ...
    {
    	String certificatesTrustStorePath = "C:/Program Files/Java/jdk1.8.0_121/jre/lib/security/cacerts";
    ...
    public static Credential getCredentials()
    {
    	try
    	{
    		...
    		Credential  credential = new Auth().createWebCredentials(scopes, "commentthreads1");
    ...
    public static void publishPostComment(Credential credential)
    {
        ...
        try 
        {
            ...
            // Authorize the request with Web credentials.
            //Credential credential = new Auth().createWebCredentials(scopes, "commentthreads1");

        	// Authorize the request with Service Credentials.
        	//Credential credential = new Auth().createServiceCredentials(scopes);
        	
        	// Authorize the request with Application Credentials.
        	//Credential credential = new Auth().createApplicationCredentials(scopes);
            ...
            String channelId = "UCvyKO0qwc07WwaKMZwlKVdQ";//getChannelId();
            ...
            String videoId = "kNGy4H7TbQI";;//getVideoId();
    		...
    		String message)
    {
        ...
        try 
        {
            ...
            Credential credential = Auth.autorize(scopes, "commentthreads");
            
        	// Authorize the request with Service Credentials.
        	//Credential credential = Auth.createServiceCredential(scopes);
            ...
            // This object is used to make YouTube Data API requests.
            youtube = new YouTube.Builder(Auth.HTTP_TRANSPORT, Auth.JSON_FACTORY, credential)
                    .setApplicationName("youtube-commentthreads").build();

            // Prompt the user for the ID of a channel to comment on.
            // Retrieve the channel ID that the user is commenting to.
            String channelId = channelIdI;//getChannelId();
            System.out.println("You chose " + channelId + " to subscribe.");

            // Prompt the user for the ID of a video to comment on.
            // Retrieve the video ID that the user is commenting to.
            String videoId = targetId;//getVideoId();
            System.out.println("You chose " + videoId + " to subscribe.");

            // Prompt the user for the comment text.
            // Retrieve the text that the user is commenting.
            String text = message + System.lineSeparator() + linksUrl;//getText();
            System.out.println("You chose " + text + " to subscribe.");
